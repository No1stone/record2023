...
public class StringAnalysisVo {
    ...
    public static StringAnalysisVo builder() {
        return new StringAnalysisVo();
    }

    public StringAnalysisVo answer(String s) {
        this.answer = s;
        return this;
    }

    public StringAnalysisVo stt(String s) {
        this.sttAnswer = s;
        return this;
    }

    public StringAnalysisVo build() {
        return this;
    }
